...
rule trim_galore:
    ...
    params:
        outdir = lambda wildcards, output: wildcards.outdir
    shell:
        "trim_galore --phred33 --fastqc --gzip --paired -o {params.outdir} {r1} {r2}"

rule snpsplit_create_path:
    input:
        "../genome_data/GRCm38_90.fa",
    output:
        "../genome_data/snpsplit_prepare_genome/GRCm38_90.fa"
    shell:
        "cp {input} {output}"

rule snpsplit_prepare_genome:
    input:
        genome = "../genome_data/snpsplit_prepare_genome/GRCm38_90.fa",
        vcf = "../genome_data/CAST_EiJ.mgp.v5.snps.dbSNP142.vcf"
    output:
        "../genome_data/snpsplit_prepare_genome/CAST_EiJ_N-masked/chr1.N-masked.fa",
        "../genome_data/snpsplit_prepare_genome/CAST_EiJ_N-masked/chr2.N-masked.fa",
        "../genome_data/snpsplit_prepare_genome/CAST_EiJ_N-masked/chr3.N-masked.fa",
        "../genome_data/snpsplit_prepare_genome/CAST_EiJ_N-masked/chr4.N-masked.fa",
        "../genome_data/snpsplit_prepare_genome/CAST_EiJ_N-masked/chr5.N-masked.fa",
        "../genome_data/snpsplit_prepare_genome/CAST_EiJ_N-masked/chr6.N-masked.fa",
        "../genome_data/snpsplit_prepare_genome/CAST_EiJ_N-masked/chr7.N-masked.fa",
        "../genome_data/snpsplit_prepare_genome/CAST_EiJ_N-masked/chr8.N-masked.fa",
        "../genome_data/snpsplit_prepare_genome/CAST_EiJ_N-masked/chr9.N-masked.fa",
        "../genome_data/snpsplit_prepare_genome/CAST_EiJ_N-masked/chr10.N-masked.fa",
        "../genome_data/snpsplit_prepare_genome/CAST_EiJ_N-masked/chr11.N-masked.fa",
        "../genome_data/snpsplit_prepare_genome/CAST_EiJ_N-masked/chr12.N-masked.fa",
        "../genome_data/snpsplit_prepare_genome/CAST_EiJ_N-masked/chr13.N-masked.fa",
        "../genome_data/snpsplit_prepare_genome/CAST_EiJ_N-masked/chr14.N-masked.fa",
        "../genome_data/snpsplit_prepare_genome/CAST_EiJ_N-masked/chr15.N-masked.fa",
        "../genome_data/snpsplit_prepare_genome/CAST_EiJ_N-masked/chr16.N-masked.fa",
        "../genome_data/snpsplit_prepare_genome/CAST_EiJ_N-masked/chr17.N-masked.fa",
        "../genome_data/snpsplit_prepare_genome/CAST_EiJ_N-masked/chr18.N-masked.fa",
        "../genome_data/snpsplit_prepare_genome/CAST_EiJ_N-masked/chr19.N-masked.fa",
        "../genome_data/snpsplit_prepare_genome/CAST_EiJ_N-masked/chrX.N-masked.fa",
        "../genome_data/snpsplit_prepare_genome/CAST_EiJ_N-masked/chrY.N-masked.fa",
        "../genome_data/snpsplit_prepare_genome/CAST_EiJ_N-masked/chrMT.N-masked.fa",
        "../genome_data/all_SNPs_CAST_EiJ_GRCm38.txt.gz",
    shell:
        "SNPsplit_genome_preparation --vcf_file {input.vcf} --strain CAST_EiJ --reference_genome $(basename {input.genome})"
...
rule clean_up_snpsplit_genome:
    input:
        ...
        "../genome_data/snpsplit_prepare_genome/CAST_EiJ_N-masked/chrMT.N-masked.fa",
    params:
        tempdir = "../genome_data/snpsplit_prepare_genome/"
    output:
        "../genome_data/GRCm38.Cast_N-masked.fa"
    shell:
        "cat {input} > {output} && rm {params.tempdir}"
...
rule samtools_depth:
    input:
        ...
        index = ("../rna_seq/B6CastF1_2.hisat2.genome1.bam.bai",
                 ...
                 "../rna_seq/CastB6F1_6.hisat2.genome2.bam.bai")
    output:
