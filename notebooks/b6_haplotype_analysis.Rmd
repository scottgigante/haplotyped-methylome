...
load("../RData/albacore_1.2.2.b6/summary_df.RData")
load("../RData/albacore_1.2.2.b6/fit_reads_df.RData")
```
...
p
ggsave("../plots/single_strain_validation/b6.paper_haplotype_decision_frequency.png", dpi=200, width=2, height=4)
```
...
p
ggsave("../plots/single_strain_validation/b6.paper_haplotype_by_chr.png", dpi=200, width=8, height=4)
```
...
p
ggsave("../plots/single_strain_validation/b6.paper_haplotype_score_combination.png", dpi=200, height=4, width=4)
```
