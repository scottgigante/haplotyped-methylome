...
p
ggsave("../plots/b6.paper_haplotype_decision_frequency.png", dpi=200, width=2, height=4)
```
...
p
ggsave("../plots/b6.paper_haplotype_by_chr.png", dpi=200, width=8, height=4)
```
...
p
ggsave("../plots/b6.paper_haplotype_score_combination.png", dpi=200, height=4, width=4)
```
