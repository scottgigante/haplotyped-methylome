...
```{r}
load("../RData/albacore_1.2.2.b6xcast/haplotype_df.RData")
load("../RData/albacore_1.2.2.b6xcast/fit_reads_df.RData")
load("../RData/albacore_1.2.2.b6xcast/summary_df.RData")
```
...
p
ggsave("../plots/haplotype_decision_frequency.pdf", width=4, height=4)
```
...
p
ggsave("../plots/haplotype_by_chr.pdf", width=8, height=4)
```
...
p
ggsave("../plots/haplotype_score_combination.pdf", height=4, width=6)
```
