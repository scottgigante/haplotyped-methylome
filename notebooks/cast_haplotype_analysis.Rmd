...
p
ggsave("../plots/cast.haplotype_decision_frequency.pdf", width=2, height=4)
```
...
p
ggsave("../plots/cast.haplotype_by_chr.pdf", width=8, height=4)
```
...
p
ggsave("../plots/cast.haplotype_score_combination.pdf", height=4, width=4)
ggsave("../plots/cast.mainfig_haplotype_score_combination.pdf", height=4, width=6)
```
