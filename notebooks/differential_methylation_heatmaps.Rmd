...
rolling_t_df_forward <- read_tsv("../nanopore/albacore_1.2.2.b6xcast.compare_haplotype_methylation.tsv") %>%
  ...
  unique()
rolling_t_df_reverse <- read_tsv("../nanopore/albacore_2.2.7.castxb6.promethion.fastq.compare_haplotype_methylation.tsv") %>%
  mutate(chr=as.character(chr)) %>%
...
ggsave("../plots/paper_primary_ICRs.png", width=8, height=10, plot=p)
```
