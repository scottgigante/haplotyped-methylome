...
ggplot(base_roc, aes(x=fpr, y=tpr)) +
  geom_line() +
  labs(title=paste0("AUC=",MESS::auc(base_roc$fpr, base_roc$tpr) %>% round(3)))
ggplot(signal_roc, aes(x=fpr, y=tpr)) +
  geom_line() +
  labs(title=paste0("AUC=",MESS::auc(signal_roc$fpr, signal_roc$tpr) %>% round(3)))
```
...
ggplot(glm_roc, aes(x=fpr, y=tpr)) +
  geom_line() +
  labs(title=paste0("AUC=",MESS::auc(glm_roc$fpr, glm_roc$tpr) %>% round(3)))
```
