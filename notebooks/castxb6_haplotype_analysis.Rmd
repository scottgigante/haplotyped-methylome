...
```{r}
load("../RData/albacore_2.2.7.castxb6.promethion/haplotype_df.RData")
load("../RData/albacore_2.2.7.castxb6.promethion/summary_df.RData")
...
p
ggsave("../plots/reverse_cross/reverse.paper_haplotype_decision_frequency.png", dpi=200, width=2, height=4)
```
...
p
ggsave("../plots/reverse_cross/reverse.paper_haplotype_by_chr.png", dpi=200, width=8, height=4)
```
...
p
ggsave("../plots/reverse_cross/reverse_haplotype_score_combination.png", dpi=200, height=4, width=4)
```
