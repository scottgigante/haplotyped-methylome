---
title: "Cast x B6 F1 Haplotype Analysis"
...
p
ggsave("../plots/castxb6.haplotype_decision_frequency.png", dpi=200, width=2, height=4)
```
...
p
ggsave("../plots/castxb6.haplotype_by_chr.png", dpi=200, width=8, height=4)
```
...
p
ggsave("../plots/castxb6.haplotype_score_combination.png", dpi=200, height=4, width=4)
```
