...
p
ggsave("../plots/castxb6.haplotype_decision_frequency.pdf", width=2, height=4)
```
...
p
ggsave("../plots/castxb6.haplotype_by_chr.pdf", width=8, height=4)
```
...
p
ggsave("../plots/castxb6.haplotype_score_combination.pdf", height=4, width=4)
```
